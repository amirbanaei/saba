...
!function (t, e) {
        ...
        return r(t, [{
            ...
            key: "renderPaths", value: function (t) {
                var i, a = t.j, s = t.realIndex, r = t.pathFrom, o = t.pathTo, n = t.stroke, l = t.strokeWidth,
                    ...
                    p = t.className, f = t.shouldClipToGrid, x = void 0 === f || f, b = t.bindEventsOnPaths,
                    y = void 0 === b || b, w = t.drawShadow, k = void 0 === w || w, A = this.w, S = new m(this.ctx),
                    C = new v(this.ctx), L = this.w.config.chart.animations.enabled,
            ...
            key: "pathMouseEnter", value: function (t, e) {
                var i = this.w, a = new m(this.ctx), s = parseInt(t.node.getAttribute("index"), 10),
        ...
        return r(t, [{
            ...
            key: "getY1Y2", value: function (t, e) {
                ...
                if (this.annoCtx.invertAxis) {
                    ...
                    var o = r.indexOf(a),
                        n = s.globals.dom.baseEl.querySelector(".apexcharts-yaxis-texts-g text:nth-child(" + (o + 1) + ")");
                    ...
                    var l;
                    if (s.config.yaxis[e.yAxisIndex].logarithmic) l = (a = new w(this.annoCtx.ctx).getLogVal(a, e.yAxisIndex)) / s.globals.yLogRatio[e.yAxisIndex]; else l = (a - s.globals.minYArr[e.yAxisIndex]) / (s.globals.yRange[e.yAxisIndex] / s.globals.gridHeight);
    ...
    var L = {
        ...
        return r(t, [{
            ...
            key: "handlePatternFill", value: function (t) {
                ...
                e && (o = e);
                var n = this.opts, l = new y(this.ctx),
            ...
            key: "handleGradientFill", value: function (t) {
                ...
                s && (o = e(e({}, o), s));
                var n, l = this.opts, h = new y(this.ctx), c = new b, d = o.gradient.type, g = i,
                ...
                if (void 0 === o.gradient.gradientToColors || 0 === o.gradient.gradientToColors.length) n = "dark" === o.gradient.shade ? c.shadeColor(-1 * parseFloat(o.gradient.shadeIntensity), i.indexOf("rgb") > -1 ? b.rgb2hex(i) : i) : c.shadeColor(parseFloat(o.gradient.shadeIntensity), i.indexOf("rgb") > -1 ? b.rgb2hex(i) : i); else if (o.gradient.gradientToColors[l.seriesNumber]) {
        ...
        return r(t, [{
            ...
            key: "plotChartMarkers", value: function (t, e, i, a) {
                var s, r = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], o = this.w, n = e, l = t,
                    h = null, c = new y(this.ctx), d = o.config.markers.discrete && o.config.markers.discrete.length;
        ...
        return r(t, [{
            key: "draw", value: function (t, e, i) {
                var a = this.w, s = new y(this.ctx), r = i.realIndex, o = i.pointsPos, n = i.zRatio, l = i.elParent,
            ...
            key: "drawPoint", value: function (t, e, i, a, s, r, o) {
                var n = this.w, l = s, h = new v(this.ctx), c = new m(this.ctx), d = new H(this.ctx),
                    g = new D(this.ctx), u = new y(this.ctx), p = g.getMarkerConfig({
        ...
        return r(t, [{
            ...
            key: "drawDataLabel", value: function (t) {
                var e = this, i = t.type, a = t.pos, s = t.i, r = t.j, o = t.isRangeStart, n = t.strokeWidth,
                    l = void 0 === n ? 2 : n, h = this.w, c = new y(this.ctx), d = h.config.dataLabels, g = 0, u = 0,
                    p = r, f = null;
                ...
                for (var x = 0; x < a.x.length; x++) if (g = a.x[x] + d.offsetX, u = a.y[x] + d.offsetY + l, !isNaN(g)) {
                    ...
                    if ("bubble" === h.config.chart.type) v = m(b = h.globals.seriesZ[s][p]), u = a.y[x], u = new O(this.ctx).centerTextInBubble(u, s, p).y; else void 0 !== b && (v = m(b));
            ...
            key: "plotDataLabelsText", value: function (t) {
                var e = this.w, i = new y(this.ctx), a = t.x, s = t.y, r = t.i, o = t.j, n = t.text, l = t.textAnchor,
        ...
        return r(t, [{
            ...
            key: "exportToCSV", value: function (t) {
                ...
                d.push(l.config.chart.toolbar.export.csv.headerCategory), "boxPlot" === l.config.chart.type ? (d.push("minimum"), d.push("q1"), d.push("median"), d.push("q3"), d.push("maximum")) : "candlestick" === l.config.chart.type ? (d.push("open"), d.push("high"), d.push("low"), d.push("close")) : "rangeBar" === l.config.chart.type ? (d.push("minimum"), d.push("maximum")) : i.map((function (t, e) {
                    ...
                    g.push([x(t) && "datetime" === l.config.xaxis.type ? l.config.chart.toolbar.export.csv.dateFormatter(t) : b.isNumber(t) ? t : t.split(r).join(""), c[t].join(r)])
        ...
        return r(t, [{
            ...
            key: "drawXaxisInversed", value: function (t) {
                var e, i, a = this, s = this.w, r = new y(this.ctx),
        ...
        return r(t, [{
            ...
            key: "createGridMask", value: function () {
                var t = this.w, e = t.globals, i = new y(this.ctx),
            ...
            key: "_drawGridBandRect", value: function (t) {
                var e = t.c, i = t.x1, a = t.y1, s = t.x2, r = t.y2, o = t.type, n = this.w, l = new y(this.ctx),
            ...
            key: "renderGrid", value: function () {
                ...
                } else a = s, s = t.globals.xTickAmount, this._drawInvertedXYLines({xCount: a, tickAmount: s});
            ...
            key: "niceScale", value: function (t, e) {
                ...
                if (s && r) {
                    ...
                    if (d) if (c) if (0 != b.mod(x, v)) {
                        var C = b.getGCD(v, S);
                        v = S / C < 10 ? C : S
                    } else 0 == b.mod(v, S) ? v = S : (S = v, d = !1); else v = S; else if (c) 0 == b.mod(x, v) ? S = v : v = S; else if (0 == b.mod(x, v)) S = v; else {
                        S = x / (f = Math.ceil(x / v));
                        var L = b.getGCD(x, v);
                        x / L < a && (S = L), v = S
                    }
        ...
        return r(t, [{
            ...
            key: "setYRange", value: function () {
                ...
                return t.isMultipleYAxis ? (this.scales.setMultipleYScales(), t.minY = a) : (this.scales.setYScaleForIndex(0, t.minY, t.maxY), t.minY = t.yAxisScale[0].niceMin, t.maxY = t.yAxisScale[0].niceMax, t.minYArr[0] = t.yAxisScale[0].niceMin, t.maxYArr[0] = t.yAxisScale[0].niceMax, t.seriesYAxisMap = [t.series.map((function (t, e) {
                    return e
            ...
            key: "setZRange", value: function () {
                ...
                if (t.isDataXYZ) for (var e = 0; e < t.series.length; e++) if (void 0 !== t.seriesZ[e]) for (var i = 0; i < t.seriesZ[e].length; i++) null !== t.seriesZ[e][i] && b.isNumber(t.seriesZ[e][i]) && (t.maxZ = Math.max(t.maxZ, t.seriesZ[e][i]), t.minZ = Math.min(t.minZ, t.seriesZ[e][i]))
            }
        }, {
        ...
        return r(t, [{
            key: "drawYaxis", value: function (t) {
                var e = this, i = this.w, a = new y(this.ctx), s = i.config.yaxis[t].labels.style, r = s.fontSize,
                ...
                if (void 0 !== i.config.yaxis[t].title.text) {
                    var v = a.group({class: "apexcharts-yaxis-title"}), m = 0;
        ...
        return r(t, [{
            key: "drawAxis", value: function (t, e) {
                var i, a, s = this, r = this.w.globals, o = this.w.config, n = new j(this.ctx, e),
                    l = new Z(this.ctx, e);
        ...
        return r(t, [{
            key: "drawXCrosshairs", value: function () {
                var t = this.w, e = new y(this.ctx), i = new m(this.ctx), a = t.config.xaxis.crosshairs.fill.gradient,
                    ...
                    u = s.top, p = s.blur, f = s.color, x = s.opacity, v = t.config.xaxis.crosshairs.fill.color;
            ...
            key: "drawYCrosshairs", value: function () {
                var t = this.w, e = new y(this.ctx), i = t.config.yaxis[0].crosshairs,
        ...
        return r(t, [{
            key: "getxAxisLabelsCoords", value: function () {
                ...
                if (e.config.xaxis.convertedCatToNumeric && 0 === i.length && (i = e.globals.categoryLabels), e.globals.timescaleLabels.length > 0) {
                    ...
                    var s = e.globals.xLabelFormatter, r = b.getLargestStringFromArr(i),
            ...
            key: "getxAxisGroupLabelsCoords", value: function () {
                ...
                var i,
                    ...
                    s = e.globals.groups.map((function (t) {
                        return t.title
                    })), r = b.getLargestStringFromArr(s), o = this.dCtx.dimHelpers.getLargestStringFromMultiArr(r, s),
                    n = new y(this.dCtx.ctx), l = n.getTextRects(r, a), h = l;
            ...
            key: "getyAxisLabelsCoords", value: function () {
                ...
                return e.config.yaxis.map((function (r, o) {
                    ...
                    if (!s.isYAxisHidden(o) && r.labels.show && void 0 !== r.labels.minWidth && (h = r.labels.minWidth), !s.isYAxisHidden(o) && r.labels.show && l.result.length) {
                        ...
                        var f = new y(t.dCtx.ctx), x = "rotate(".concat(r.labels.rotate, " 0 0)"),
                            v = f.getTextRects(g, r.labels.style.fontSize, r.labels.style.fontFamily, x, !1), m = v;
            ...
            key: "getyAxisTitleCoords", value: function () {
                ...
                return e.config.yaxis.map((function (e, a) {
                    if (e.show && void 0 !== e.title.text) {
                        var s = new y(t.dCtx.ctx), r = "rotate(".concat(e.title.rotate, " 0 0)"),
        ...
        return r(t, [{
            ...
            key: "hideSeries", value: function (t) {
                ...
                if (a.globals.axisCharts) {
                    ...
                    }), a.globals.ancillaryCollapsedSeriesIndices.push(i)); else if (a.globals.collapsedSeriesIndices.indexOf(i) < 0) {
        ...
        return r(t, [{
            ...
            key: "drawLegends", value: function () {
                ...
                for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
                    ...
                    var x = e.config.legend.markers.offsetX, v = e.config.legend.markers.offsetY,
                        m = e.config.legend.markers.height, k = e.config.legend.markers.width,
            ...
            key: "setLegendWrapXY", value: function (t, e) {
                ...
                if ("bottom" === i.config.legend.position) o += i.globals.svgHeight - s.height / 2; else if ("top" === i.config.legend.position) {
                    var n = new nt(this.ctx), l = n.dimHelpers.getTitleSubtitleCoords("title").height,
            ...
            key: "zoomUpdateOptions", value: function (t, e) {
                ...
                if (void 0 !== t || void 0 !== e) {
                    if (!(i.config.xaxis.convertedCatToNumeric && (t < 1 && (t = 1, e = i.globals.dataPoints), e - t < 2))) {
                        ...
                        s && (a = s.xaxis);
                        var r = {xaxis: a}, o = b.clone(i.globals.initialConfig.yaxis);
        ...
        function i(t) {
            var s;
            return a(this, i), (s = e.call(this, t)).ctx = t, s.w = t.w, s.dragged = !1, s.graphics = new y(s.ctx), s.eventList = ["mousedown", "mouseleave", "mousemove", "touchstart", "touchmove", "mouseup", "touchend"], s.clientX = 0, s.clientY = 0, s.startX = 0, s.endX = 0, s.dragX = 0, s.startY = 0, s.endY = 0, s.dragY = 0, s.moveDirection = "none", s
        }
        ...
        return r(i, [{
            ...
            key: "panScrolled", value: function (t, e) {
                var i = this.w, a = this.xyRatios, s = b.clone(i.globals.initialConfig.yaxis), r = a.xRatio,
        ...
        return r(t, [{
            ...
            key: "create", value: function (t, i, a, s, r) {
                var o, n, l, h, c, d, g, u, p, f, x, b, v, m, w, k,
        ...
        return r(t, [{
            key: "handleBarDataLabels", value: function (t) {
                var e = t.x, i = t.y, a = t.y1, s = t.y2, r = t.i, o = t.j, n = t.realIndex, l = t.groupIndex,
                    ...
                    p = t.visibleSeries, f = t.renderedPath, x = this.w, b = new y(this.barCtx.ctx),
                    v = Array.isArray(this.barCtx.strokeWidth) ? this.barCtx.strokeWidth[n] : this.barCtx.strokeWidth,
                    m = e + parseFloat(d * p), w = i + parseFloat(c * p);
            ...
            key: "calculateColumnsDataLabelsPosition", value: function (t) {
                var e, i, a = this.w, s = t.i, r = t.j, o = t.realIndex, n = t.groupIndex, l = t.y, h = t.bcx,
                    ...
                    v = t.strokeWidth, m = t.offX, w = t.offY;
                d = Math.abs(d);
            ...
            key: "drawCalculatedDataLabels", value: function (t) {
                ...
                var u = new N(this.barCtx.ctx), p = new y(this.barCtx.ctx), f = c.formatter, x = null,
            ...
            key: "drawTotalDataLabels", value: function (t) {
                var e, i = t.x, a = t.y, s = t.val, r = t.barWidth, o = t.barHeight, n = t.realIndex, l = t.textAnchor,
                    h = t.barTotalDataLabelsConfig, c = this.w, d = new y(this.barCtx.ctx);
        ...
        return r(t, [{
            ...
            key: "barBackground", value: function (t) {
                var e = t.j, i = t.i, a = t.x1, s = t.x2, r = t.y1, o = t.y2, n = t.elSeries, l = this.w,
                    h = new y(this.barCtx.ctx), c = new W(this.barCtx.ctx).getActiveConfigSeriesIndex();
            ...
            key: "drawBarShadow", value: function (t) {
                var e = t.prevPaths, i = t.currPaths, a = t.color, s = this.w, r = e.x, o = e.x1, n = e.barYPosition,
                    l = i.x, h = i.x1, c = i.barYPosition, d = n + i.barHeight, g = new y(this.barCtx.ctx), u = new b,
        ...
        return r(t, [{
            key: "draw", value: function (t, i) {
                ...
                for (var n = 0, l = 0; n < t.length; n++, l++) {
                    var h, c, d, g, u = void 0, p = void 0, f = [], x = [], v = a.globals.comboCharts ? i[n] : n,
                        m = s.group({
                    ...
                    for (var M = 0; M < t[n].length; M++) {
                        var I = this.barHelpers.getStrokeWidth(n, M, v), T = null,
                            z = {indexes: {i: n, j: M, realIndex: v, bc: l}, x: u, y: p, strokeWidth: I, elSeries: m};
            ...
            key: "renderSeries", value: function (t) {
                var e = t.realIndex, i = t.pathFill, a = t.lineFill, s = t.j, r = t.i, o = t.groupIndex, n = t.pathFrom,
                    ...
                    x = t.barHeight, b = t.barWidth, v = t.barXPosition, w = t.barYPosition, k = t.elDataLabelsWrap,
        ...
        return r(s, [{
            key: "draw", value: function (t, i, a) {
                var s = this, r = this.w, o = new y(this.ctx), n = r.globals.comboCharts ? i : r.config.chart.type,
                    l = new H(this.ctx);
                ...
                for (var c = o.group({class: "apexcharts-".concat(n, "-series apexcharts-plot-series")}), d = function (i) {
                    ...
                    var n, h, d, g, u = void 0, p = void 0, f = [], x = [], v = r.globals.comboCharts ? a[i] : i,
                        m = o.group({
                            class: "apexcharts-series",
                    ...
                    for (var A = o.group({class: "apexcharts-datalabels", "data:realIndex": v}), S = function (a) {
                        var o = s.barHelpers.getStrokeWidth(i, a, v), c = null,
                            b = {indexes: {i: i, j: a, realIndex: v}, x: u, y: p, strokeWidth: o, elSeries: m};
            ...
            key: "drawVerticalBoxPaths", value: function (t) {
                ...
                t.y;
                var a = t.xDivision, s = t.barWidth, r = t.zeroH, o = t.strokeWidth, n = this.w, l = new y(this.ctx),
                ...
                return n.globals.previousPaths.length > 0 && (L = this.getPreviousPath(x, c, !0)), C = this.isBoxPlot ? [l.move(S, w) + l.line(S + s / 2, w) + l.line(S + s / 2, v) + l.line(S + s / 4, v) + l.line(S + s - s / 4, v) + l.line(S + s / 2, v) + l.line(S + s / 2, w) + l.line(S + s, w) + l.line(S + s, A) + l.line(S, A) + l.line(S, w + o / 2), l.move(S, A) + l.line(S + s, A) + l.line(S + s, k) + l.line(S + s / 2, k) + l.line(S + s / 2, m) + l.line(S + s - s / 4, m) + l.line(S + s / 4, m) + l.line(S + s / 2, m) + l.line(S + s / 2, k) + l.line(S, k) + l.line(S, A) + "z"] : [l.move(S, k) + l.line(S + s / 2, k) + l.line(S + s / 2, v) + l.line(S + s / 2, k) + l.line(S + s, k) + l.line(S + s, w) + l.line(S + s / 2, w) + l.line(S + s / 2, m) + l.line(S + s / 2, w) + l.line(S, w) + l.line(S, k - o / 2)], L += l.move(S, w), n.globals.isXNumeric || (i += a), {
                    pathTo: C,
                    pathFrom: L,
                    x: i,
                    y: k,
            ...
            key: "drawHorizontalBoxPaths", value: function (t) {
                ...
                var i = t.y, a = t.yDivision, s = t.barHeight, r = t.zeroW, o = t.strokeWidth, n = this.w,
                    l = new y(this.ctx), h = e.i, c = e.j, d = this.boxOptions.colors.lower;
                ...
                var g = this.invertedYRatio, u = e.realIndex, p = this.getOHLCValue(u, c), f = r, x = r,
                    b = Math.min(p.o, p.c), v = Math.max(p.o, p.c), m = p.m;
        ...
        return r(t, [{
            ...
            key: "calculateDataLabels", value: function (t) {
                var e = t.text, i = t.x, a = t.y, s = t.i, r = t.j, o = t.colorProps, n = t.fontSize,
                    l = this.w.config.dataLabels, h = new y(this.ctx), c = new N(this.ctx), d = null;
                if (l.enabled) {
        ...
        return r(t, [{
            key: "draw", value: function (t) {
                ...
                var p = i.config.plotOptions.pie.customScale, f = i.globals.gridWidth / 2, x = i.globals.gridHeight / 2,
                    v = f - i.globals.gridWidth / 2 * p, m = x - i.globals.gridHeight / 2 * p;
                ...
                if (this.sliceLabels.forEach((function (t) {
                    k.add(t)
                })), n.attr({transform: "translate(".concat(v, ", ").concat(m, ") scale(").concat(p, ")")}), n.add(k), this.ret.add(n), this.donutDataLabels.show) {
            ...
            key: "drawArcs", value: function (t, e) {
                var i = this.w, a = new m(this.ctx), s = new y(this.ctx), r = new H(this.ctx),
            ...
            key: "getPiePath", value: function (t) {
                var e, i = t.me, a = t.startAngle, s = t.angle, r = t.size, o = new y(this.ctx), n = a,
                ...
                var c = Math.PI * (h - 90) / 180, d = i.centerX + r * Math.cos(l), g = i.centerY + r * Math.sin(l),
                    ...
                    f = b.polarToCartesian(i.centerX, i.centerY, i.donutSize, h),
                    x = b.polarToCartesian(i.centerX, i.centerY, i.donutSize, n), v = s > 180 ? 1 : 0,
                    m = ["M", d, g, "A", r, r, 0, v, 1, u, p];
                return e = "donut" === i.chartType ? [].concat(m, ["L", f.x, f.y, "A", i.donutSize, i.donutSize, 0, v, 0, x.x, x.y, "L", d, g, "z"]).join(" ") : "pie" === i.chartType || "polarArea" === i.chartType ? [].concat(m, ["L", i.centerX, i.centerY, "L", d, g]).join(" ") : [].concat(m).join(" "), o.roundPathCorners(e, 2 * this.strokeWidth)
            }
        }, {
            key: "drawPolarElements", value: function (t) {
                var e = this.w, i = new U(this.ctx), a = new y(this.ctx), s = new Lt(this.ctx), r = a.group(),
        ...
        return r(i, [{
            ...
            key: "drawTracks", value: function (t) {
                var e = this.w, i = new y(this.ctx), a = i.group({class: "apexcharts-tracks"}), s = new m(this.ctx),
            ...
            key: "drawArcs", value: function (t) {
                var e = this.w, i = new y(this.ctx), a = new H(this.ctx), s = new m(this.ctx), r = i.group(),
                ...
                for (var f = p ? t.series.length - 1 : 0; p ? f >= 0 : f < t.series.length; p ? f-- : f++) {
                    ...
                    var v = a.fillPath({seriesNumber: f, size: t.size, value: t.series[f]}), w = this.startAngle,
                        k = void 0, A = b.negToZero(t.series[f] > 100 ? 100 : t.series[f]) / 100,
                    ...
                    if (s.setSelectionFilter(M, 0, f), this.addListeners(M, this.radialDataLabels), x.add(M), M.attr({
                        ...
                        var T = b.polarToCartesian(t.centerX, t.centerY, t.size, w),
                ...
                for (var r = s.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), n = 0; n < t.length; n++) {
                    ...
                    for (var w = s.group({
                        ...
                        var S, C = this.barHelpers.getStrokeWidth(n, A, p), L = this.seriesRangeStart[n][A],
                            P = this.seriesRangeEnd[n][A], M = null, I = null, T = null,
    ...
    var Rt = function () {
        ...
        return r(t, [{
            key: "draw", value: function (t, i, a, s) {
                var r, o = this.w, n = new y(this.ctx), l = o.globals.comboCharts ? i : o.config.chart.type,
                ...
                for (var d = [], g = 0; g < t.length; g++) {
                    ...
                    if ("rangeArea" === l) {
                        var M = this._calculatePathsFrom({series: s, i: g, realIndex: u, prevX: A, prevY: C}),
            ...
            key: "_calculatePathsFrom", value: function (t) {
                var e, i, a, s, r = t.type, o = t.series, n = t.i, l = t.realIndex, h = t.prevX, c = t.prevY,
                    d = t.prevY2, g = this.w, u = new y(this.ctx);
                if (null === o[n][0]) {
            ...
            key: "_handlePaths", value: function (t) {
                var i = t.type, a = t.realIndex, s = t.i, r = t.paths, o = this.w, n = new y(this.ctx),
                    l = new H(this.ctx);
            ...
            key: "_iterateOverDataPoints", value: function (t) {
                var e, i = this, a = t.type, s = t.series, r = t.iterations, o = t.realIndex, n = t.i, l = t.x, h = t.y,
                    ...
                    x = t.lineYPosition, v = t.xArrj, m = t.yArrj, w = t.y2Arrj, k = t.isRangeStart,
                    A = t.seriesRangeEnd, S = this.w, C = new y(this.ctx), L = this.yRatio, P = g.prevY, M = g.linePath,
                    I = g.areaPath, T = g.pathFromLine, z = g.pathFromArea,
                    X = b.isNumber(S.globals.minYArr[o]) ? S.globals.minYArr[o] : S.globals.minY;
                ...
                for (var E = function (t, e) {
                    ...
                    } else x = this.zeroY; else x = this.zeroY;
            ...
            key: "_createPaths", value: function (t) {
                var e = t.type, i = t.series, a = t.i, s = t.realIndex, r = t.j, o = t.x, n = t.y, l = t.xArrj,
                    ...
                    x = t.linePaths, b = t.areaPaths, v = t.seriesIndex, m = t.isRangeStart, w = this.w,
    ...
    var Ht, Dt, Ot = function () {
        ...
        return r(t, [{
            key: "draw", value: function (t) {
                var e = this, i = this.w, a = new y(this.ctx), s = new H(this.ctx),
        ...
        return r(t, [{
            key: "calculateTimeScaleTicks", value: function (t, i) {
                ...
                var n = r.getTimeUnitsfromTimestamp(t, i, this.utc), l = s.globals.gridWidth / o, h = l / 24,
                    c = h / 60, d = c / 60, g = Math.floor(24 * o), u = Math.floor(1440 * o), p = Math.floor(o * Nt),
        ...
        return r(t, [{
            ...
            key: "plotChartType", value: function (t, e) {
                ...
                if (s.comboCharts) {
                    ...
                    case "area":
                        ...
                        break;
                    case "bar":
                        if (a.chart.stacked) v = new kt(this.ctx, e).draw(s.series); else this.ctx.bar = new wt(this.ctx, e), v = this.ctx.bar.draw(s.series);
                        break;
                    case "candlestick":
            ...
            key: "resizeNonAxisCharts", value: function () {
                ...
                e.dom.elLegendForeign && e.dom.elLegendForeign.setAttribute("height", l), t.config.chart.height && String(t.config.chart.height).indexOf("%") > 0 || (e.dom.elWrap.style.height = l + "px", y.setAttrs(e.dom.Paper.node, {height: l}), e.dom.Paper.node.parentNode.parentNode.style.minHeight = l + "px")
            }
        }, {
        ...
        return r(t, [{
            ...
            key: "_updateSeries", value: function (t, e) {
                ...
                return new Promise((function (s) {
                    ...
                    }))).length && (r = [{data: []}]), o.config.series = r) : o.config.series = t.slice(), a && (o.globals.initialConfig.series = b.clone(o.config.series), o.globals.initialSeries = b.clone(o.config.series)), i.ctx.update().then((function () {
                        s(i.ctx)
                    }))
                }))
            }
    ...
    Ht = "undefined" != typeof window ? window : void 0, Dt = function (t, e) {
    ...
    })) : "object" === ("undefined" == typeof exports ? "undefined" : i(exports)) && "undefined" != typeof module ? module.exports = Ht.document ? Dt(Ht, Ht.document) : function (t) {
        return Dt(t, t.document)
    } : Ht.SVG = Dt(Ht, Ht.document),
                ...
                return new Promise((function (e, i) {
                    if (null !== t.el) {
                        ...
                        if ("function" == typeof a && a(t, t.w), t.events.fireEvent("beforeMount", [t, t.w]), window.addEventListener("resize", t.windowResizeHandler), function (t, e) {
                            ...
                            var s = t.el.getRootNode && t.el.getRootNode(), r = b.is("ShadowRoot", s),
