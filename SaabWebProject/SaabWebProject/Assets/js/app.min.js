        ...
        e && e.map(function (e) {
            e.onclick = function (e) {
                ...
                var e = this.closest("." + app.sidebar.menuItemClass).querySelector("." + app.sidebar.menuSubmenuClass),
                    t = getComputedStyle(e), u = "none" != t.getPropertyValue("display"),
                    d = "none" == t.getPropertyValue("display"), a = (slideToggle(e), setInterval(function () {
                        var e = document.querySelector(app.floatSubmenu.id),
                            t = document.querySelector(app.floatSubmenu.arrow.id),
                            a = document.querySelector(app.floatSubmenu.line.id), o = e.clientHeight,
                            l = e.getBoundingClientRect(), s = e.getAttribute("data-offset-top"),
                            n = e.getAttribute("data-menu-offset-top"), l = l.top, r = document.body.clientHeight;
                    ...
                    if (app.floatSubmenu.dom != this || !document.querySelector(app.floatSubmenu.class)) {
                        ...
                        if (a) {
                            var o = getComputedStyle(document.body),
                                ...
                                l = handleGetHiddenMenuHeight(t), t = this.getBoundingClientRect().top,
                                n = "rtl" != o.getPropertyValue("direction") ? s : "auto",
                                o = "rtl" != o.getPropertyValue("direction") ? "auto" : s, s = document.body.clientHeight;
                            if (document.querySelector("#" + app.floatSubmenu.id)) {
                                ...
                                var r = "",
                                    ...
                                    r = (u.setAttribute("id", app.floatSubmenu.id), u.setAttribute("class", app.floatSubmenu.class), u.setAttribute("data-offset-top", t), u.setAttribute("data-menu-offset-top", t), u.innerHTML = '\t<div class="' + app.floatSubmenu.container.class + " " + r + '">' + a + "</div>", e.appendChild(u), document.getElementById(app.floatSubmenu.id));
                            ...
                            l < s - t ? i && (i.style.top = t + "px", i.style.left = n + "px", i.style.bottom = "auto", i.style.right = o + "px") : i && (i.style.top = "auto", i.style.left = n + "px", i.style.bottom = 0, i.style.right = o + "px"), handleSidebarMinifyFloatMenuClick()
                        } else document.querySelector("#" + app.floatSubmenu.id).remove(), app.floatSubmenu.dom = ""
                    }
                }
            }, e.onmouseleave = function () {
                var e = document.querySelector("." + app.class);
                e && e.classList.contains(app.sidebar.minify.toggledClass) && (app.floatSubmenu.timeout = setTimeout(() => {
