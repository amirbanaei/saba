...
!function () {
    ...
    function m(e) {
        ...
        const p = s > n ? "next" : "prev", c = (e, t) => "next" === p && e >= t || "prev" === p && e <= t, u = () => {
    ...
    function v(e) {
        const t = r(), s = i(), a = e.getBoundingClientRect(), n = s.body, l = e.clientTop || n.clientTop || 0,
    ...
    function C(e) {
        return void 0 === e && (e = {}), A || (A = function (e) {
            ...
            const s = M(), i = r(), a = i.navigator.platform, n = t || i.navigator.userAgent,
                l = { ios: !1, android: !1 }, o = i.screen.width, d = i.screen.height,
                p = n.match(/(Android);?[\s\/]+([\d.]+)?/);
            let c = n.match(/(iPad).*OS\s([\d_]+)/);
            const u = n.match(/(iPod)(.*OS\s([\d_]+))?/), m = !c && n.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
                h = "Win32" === a;
            let f = "MacIntel" === a;
    ...
    const L = (e, t) => {
        ...
        const i = "auto" === e.params.slidesPerView ? e.slidesPerViewDynamic() : Math.ceil(e.params.slidesPerView),
            a = e.activeIndex, r = a + i - 1;
        if (e.params.rewind) for (let i = a - t; i <= r + t; i += 1) {
            const t = (i % s + s) % s;
            t !== a && t > r && k(e, t)
    ...
    var O = {
        updateSize: function () {
            ...
            const i = e.params, { wrapperEl: a, slidesEl: r, size: n, rtlTranslate: l, wrongRTL: o } = e,
                ...
                c = f(r, `.${e.params.slideClass}, swiper-slide`), m = d ? e.virtual.slides.length : c.length;
            let h = [];
            const g = [], v = [];
            ...
            let A = i.spaceBetween, T = -b, M = 0, C = 0;
            if (void 0 === n) return;
            "string" == typeof A && A.indexOf("%") >= 0 && (A = parseFloat(A.replace("%", "")) / 100 * n), e.virtualSize = -A, c.forEach((e => {
            ...
            for (let a = 0; a < m; a += 1) {
                ...
                if (z = 0, c[a] && (r = c[a]), P && e.grid.updateSlide(a, r, m, t), !c[a] || "none" !== w(r, "display")) {
                    if ("auto" === i.slidesPerView) {
                        ...
                        if (l && (r.style.transform = "none"), o && (r.style.webkitTransform = "none"), i.roundLengths) z = e.isHorizontal() ? E(r, "width", !0) : E(r, "height", !0); else {
                            const e = s(n, "width"), t = s(n, "padding-left"), i = s(n, "padding-right"),
                                a = s(n, "margin-left"), l = s(n, "margin-right"), o = n.getPropertyValue("box-sizing");
                            if (o && "border-box" === o) z = e + a + l; else {
            ...
            if (e.virtualSize = Math.max(e.virtualSize, n) + y, l && o && ("slide" === i.effect || "coverflow" === i.effect) && (a.style.width = `${e.virtualSize + i.spaceBetween}px`), i.setWrapperSize && (a.style[t("width")] = `${e.virtualSize + i.spaceBetween}px`), P && e.grid.updateWrapperSize(z, h, t), !i.centeredSlides) {
                const t = [];
            ...
            for (let e = 0; e < i.length; e += 1) {
                ...
                (c >= 0 && c < t.size - 1 || u > 1 && u <= t.size || c <= 0 && u >= t.size) && (t.visibleSlides.push(l), t.visibleSlidesIndexes.push(e), i[e].classList.add(s.slideVisibleClass)), l.progress = a ? -d : d, l.originalProgress = a ? -p : p
            }
    ...
    var G = {
        loopCreate: function (e) {
            ...
            } else a && o.slideToLoop(t, 0, !1, !0); else if (v.length > 0 && b) if (void 0 === t) {
    ...
    function Y(e) {
        const t = this, s = i(), a = r(), n = t.touchEventsData;
        n.evCache.push(e);
    ...
    function H(e) {
        ...
        c >= 0 && (a.evCache[c] = p);
        const u = a.evCache.length > 1 ? a.evCache[0] : p, m = u.pageX, h = u.pageY;
    ...
    function _(e) {
        ...
        const b = (h - d[f]) / g, y = f < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
        if (m > a.longSwipesMs) {
    ...
    const V = (e, t) => {
        const s = i(), { params: a, el: r, wrapperEl: n, device: l } = e, o = !!a.nested,
            d = "on" === t ? "addEventListener" : "removeEventListener", p = t;
        r[d]("pointerdown", e.onTouchStart, { passive: !1 }), s[d]("pointermove", e.onTouchMove, {
            passive: !1,
            capture: o
        }), s[d]("pointerup", e.onTouchEnd, { passive: !0 }), s[d]("pointercancel", e.onTouchEnd, { passive: !0 }), s[d]("pointerout", e.onTouchEnd, { passive: !0 }), s[d]("pointerleave", e.onTouchEnd, { passive: !0 }), (a.preventClicks || a.preventClicksPropagation) && r[d]("click", e.onClick, !0), a.cssMode && n[d]("scroll", e.onScroll), a.updateOnWindowResize ? e[p](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", N, !0) : e[p]("observerUpdate", N, !0), r[d]("load", e.onLoad, { capture: !0 })
    };
    ...
    const Z = {
        eventsEmitter: z, update: O, translate: $, transition: {
            ...
            attachEvents: function () {
                const e = this, t = i(), { params: s } = e;
                e.onTouchStart = Y.bind(e), e.onTouchMove = H.bind(e), e.onTouchEnd = _.bind(e), s.cssMode && (e.onScroll = R.bind(e)), e.onClick = X.bind(e), e.onLoad = j.bind(e), F || (t.addEventListener("touchstart", q), F = !0), V(e, "on")
            ...
            setBreakpoint: function () {
                ...
                const l = (n in r ? r[n] : void 0) || e.originalParams, o = W(e, i), d = W(e, l), p = i.enabled;
    ...
    class J {
        ...
        getSlideIndex(e) {
            const { slidesEl: t, params: s } = this, i = b(f(t, `.${s.slideClass}, swiper-slide`)[0]);
            return b(e) - i
        }
    ...
    function se(e) {
        ...
        if ("object" == typeof e && "length" in e) for (let t = 0; t < e.length; t += 1) e[t] && a(e[t]); else a(e);
    ...
    function pe(e, t, s) {
        const i = "swiper-slide-shadow" + (s ? `-${s}` : ""), a = h(t);
    ...
    const ce = [function (e) {
        ...
        function p(e) {
            ...
            if (e) s.slidesEl.querySelectorAll(`.${s.params.slideClass}, swiper-slide`).forEach((e => {
                e.remove()
            })); else for (let e = p; e <= c; e += 1) if (e < y || e > x) {
                const t = M(e);
                s.slidesEl.querySelectorAll(`.${s.params.slideClass}[data-swiper-slide-index="${t}"], swiper-slide[data-swiper-slide-index="${t}"]`).forEach((e => {
                    e.remove()
                }))
            }
            const C = r ? -u.length : 0, P = r ? 2 * u.length : u.length;
            for (let t = C; t < P; t += 1) if (t >= y && t <= x) {
                const s = M(t);
                void 0 === c || e ? T.push(s) : (t > c && T.push(s), t < p && A.push(s))
            }
            if (T.forEach((e => {
                s.slidesEl.append(d(u[e], e))
            })), r) for (let e = A.length - 1; e >= 0; e -= 1) {
                const t = A[e];
        ...
        r("beforeInit", (() => {
            ...
            appendSlide: function (e) {
                ...
                if (null == e) return;
                let t = s.activeIndex;
                if (Array.isArray(e)) for (let i = e.length - 1; i >= 0; i -= 1) s.virtual.slides.splice(e[i], 1), s.params.virtual.cache && delete s.virtual.cache[e[i]], e[i] < t && (t -= 1), t = Math.max(t, 0); else s.virtual.slides.splice(e, 1), s.params.virtual.cache && delete s.virtual.cache[e], e < t && (t -= 1), t = Math.max(t, 0);
                p(!0), s.slideTo(t, 0)
        ...
        function d(e) {
            ...
            const a = i.keyCode || i.charCode, r = t.params.keyboard.pageUpDown, d = r && 33 === a, p = r && 34 === a,
                c = 37 === a, u = 39 === a, m = 38 === a, h = 40 === a;
            ...
            if (!(i.shiftKey || i.altKey || i.ctrlKey || i.metaKey || l.activeElement && l.activeElement.nodeName && ("input" === l.activeElement.nodeName.toLowerCase() || "textarea" === l.activeElement.nodeName.toLowerCase()))) {
                if (t.params.keyboard.onlyInViewport && (d || p || c || u || m || h)) {
                    ...
                    const i = t.el, a = i.clientWidth, r = i.clientHeight, n = o.innerWidth, l = o.innerHeight,
                        d = v(i);
        ...
        function c(e) {
            ...
            if (t.params.loop) {
                ...
                const e = t.getSlideIndexByData(i), s = t.getSlideIndexByData(t.realIndex);
        ...
        function u() {
            ...
            if (t.params.loop ? (r = t.previousRealIndex || 0, i = t.params.slidesPerGroup > 1 ? Math.floor(t.realIndex / t.params.slidesPerGroup) : t.realIndex) : void 0 !== t.snapIndex ? (i = t.snapIndex, r = t.previousSnapIndex) : (r = t.previousIndex || 0, i = t.activeIndex || 0), "bullets" === s.type && t.pagination.bullets && t.pagination.bullets.length > 0) {
                ...
                if (s.dynamicBullets && (n = E(a[0], t.isHorizontal() ? "width" : "height", !0), c.forEach((e => {
                    ...
                    const t = b(e);
                    t === i && e.classList.add(...s.bulletActiveClass.split(" ")), s.dynamicBullets && (t >= o && t <= d && e.classList.add(...`${s.bulletActiveClass}-main`.split(" ")), t === o && p(e, "prev"), t === d && p(e, "next"))
                })); else {
                    const e = a[i];
        ...
        function x(e) {
            const s = t.params.scrollbar, { scrollbar: i, wrapperEl: a } = t, { el: n, dragEl: l } = i;
        ...
        function S(e) {
            const s = t.params.scrollbar, { scrollbar: i, wrapperEl: a } = t, { el: l } = i;
        ...
        function A(e) {
            ...
            if (!a) return;
            const r = a, n = !!i.passiveListeners && { passive: !1, capture: !1 },
        ...
        Object.assign(t.scrollbar, {
            ...
            }, disable: C, updateSize: w, setTranslate: f, init: T, destroy: M
        })
    }, function (e) {
        ...
        function T(e) {
            ...
            const r = (s.scale - p) / (m.maxRatio - t.params.zoom.minRatio), { originX: n, originY: l } = m;
        ...
        Object.defineProperty(t.zoom, "scale", {
            ...
            t.zoom.enabled && function () {
                ...
                let s = 300, i = 300;
                const a = g.x * s, r = h.currentX + a, n = g.y * i, l = h.currentY + n;
        ...
        s({
            ...
            setTranslate: function (e, s) {
                ...
                if (Array.isArray(a)) for (r = 0; r < a.length; r += 1) a[r] !== s && a[r] instanceof i && l(a[r]); else a instanceof i && s !== a && l(a)
            }
        })
    }, function (e) {
        let { swiper: t, extendParams: s, on: i } = e;
        ...
        i("beforeInit", (() => {
            a = g("span", t.params.a11y.notificationClass), a.setAttribute("aria-live", "assertive"), a.setAttribute("aria-atomic", "true"), t.isElement && a.setAttribute("slot", "container-end")
        })), i("afterInit", (() => {
        ...
        t.thumbs = { swiper: null }, a("beforeInit", (() => {
            ...
            if (e && e.swiper) if ("string" == typeof e.swiper || e.swiper instanceof HTMLElement) {
                const s = i(), a = () => {
                    ...
                    if (i && i.swiper) e.swiper = i.swiper, o(), p(!0); else if (i) {
                        const s = a => {
                    ...
                    if (s < -t.minTranslate()) t.slideTo(t.activeIndex); else if (s > -t.maxTranslate()) t.slides.length < d.length ? t.slideTo(d.length - 1) : t.slideTo(t.slides.length - 1); else {
                        if (r.freeMode.momentum) {
                            ...
                            if (c < t.maxTranslate()) r.freeMode.momentumBounce ? (c + t.maxTranslate() < -h && (c = t.maxTranslate() - h), u = t.maxTranslate(), m = !0, p.allowMomentumBounce = !0) : c = t.maxTranslate(), r.loop && r.centeredSlides && (f = !0); else if (c > t.minTranslate()) r.freeMode.momentumBounce ? (c - t.minTranslate() > h && (c = t.minTranslate() + h), u = t.minTranslate(), m = !0, p.allowMomentumBounce = !0) : c = t.minTranslate(), r.loop && r.centeredSlides && (f = !0); else if (r.freeMode.sticky) {
                                let e;
                                for (let t = 0; t < d.length; t += 1) if (d[t] > -c) {
                                    e = t;
                                    break
                                }
        ...
        let t, s, i, { swiper: a, extendParams: r } = e;
        r({ grid: { rows: 1, fill: "column" } }), a.grid = {
            initSlides: e => {
                const { slidesPerView: r } = a.params, { rows: n, fill: l } = a.params.grid;
                s = t / n, i = Math.floor(e / n), t = Math.floor(e / n) === e / n ? e : Math.ceil(e / n) * n, "auto" !== r && "row" === l && (t = Math.max(t, r * n))
            }, updateSlide: (e, r, n, l) => {
                const { slidesPerGroup: o, spaceBetween: d } = a.params, { rows: p, fill: c } = a.params.grid;
                let u, m, h;
                if ("row" === c && o > 1) {
                    const s = Math.floor(e / (o * p)), i = e - p * o * s,
                        a = 0 === s ? o : Math.min(Math.ceil((n - s * p * o) / p), o);
                    h = Math.floor(i / a), m = i - h * a + s * o, u = m + h * t / p, r.style.order = u
                } else "column" === c ? (m = Math.floor(e / p), h = e - m * p, (m > i || m === i && h === p - 1) && (h += 1, h >= p && (h = 0, m += 1))) : (h = Math.floor(e / s), m = e - h * s);
                r.style[l("margin-top")] = 0 !== h ? d && `${d}px` : ""
            }, updateWrapperSize: (e, s, i) => {
                const { spaceBetween: r, centeredSlides: n, roundLengths: l } = a.params, { rows: o } = a.params.grid;
                if (a.virtualSize = (e + r) * t, a.virtualSize = Math.ceil(a.virtualSize / o) - r, a.wrapperEl.style[i("width")] = `${a.virtualSize + r}px`, n) {
                    const e = [];
            ...
            setTranslate: () => {
                ...
                if (s.style.transformOrigin = `50% 50% -${o / 2}px`, s.style["-webkit-transform-origin"] = `50% 50% -${o / 2}px`, p.shadow) if (c) m.style.transform = `translate3d(0px, ${r / 2 + p.shadowOffset}px, ${-r / 2}px) rotateX(90deg) rotateZ(0deg) scale(${p.shadowScale})`; else {
                    const e = Math.abs(h) - 90 * Math.floor(Math.abs(h) / 90),
                        ...
                        s = p.shadowScale, i = p.shadowScale / t, a = p.shadowOffset;
        ...
        s({ coverflowEffect: { rotate: 50, stretch: 0, depth: 100, scale: 1, modifier: 1, slideShadows: !0 } }), le({
            effect: "coverflow", swiper: t, on: i, setTranslate: () => {
                ...
                for (let e = 0, t = i.length; e < t; e += 1) {
                    const t = i[e], s = a[e], l = (o - t.swiperSlideOffset - s / 2) / s,
        ...
        s({ cardsEffect: { slideShadows: !0, rotate: !0, perSlideRotate: 2, perSlideOffset: 8 } }), le({
            ...
            on: i,
            setTranslate: () => {
                const { slides: e, activeIndex: s } = t, i = t.params.cardsEffect, {
                    startTranslate: a,
                    isTouched: r
                } = t.touchEventsData, n = t.translate;
                for (let l = 0; l < e.length; l += 1) {
                    const o = e[l], d = o.progress, p = Math.min(Math.max(d, -4), 4);
                    ...
                    let u = t.params.cssMode ? -c - t.translate : -c, m = 0;
                    const h = -100 * Math.abs(p);
                    let f = 1, g = -i.perSlideRotate * p, v = i.perSlideOffset - .75 * Math.abs(p);
                    const w = t.virtual && t.params.virtual.enabled ? t.virtual.from + l : l,
                        b = (w === s || w === s - 1) && p > 0 && p < 1 && (r || t.params.cssMode) && n < a,
                        y = (w === s || w === s + 1) && p < 0 && p > -1 && (r || t.params.cssMode) && n > a;
                    if (b || y) {
                        const e = (1 - Math.abs((Math.abs(p) - .5) / .5)) ** .5;
                        g += -28 * p * e, f += -.5 * e, v += 96 * e, m = -25 * e * Math.abs(p) + "%"
                    }
                    ...
                    if (i.slideShadows) {
                        ...
                        e || (e = pe(0, o)), e && (e.style.opacity = Math.min(Math.max((Math.abs(p) - .5) / .5, 0), 1))
                    }
    ...
    function we(e) {
        ...
        })), he(t, s), t.navigation ? t.navigation = {
            prevEl: ".swiper-button-prev",
            nextEl: ".swiper-button-next", ...!0 !== t.navigation ? t.navigation : {}
        } : !1 === t.navigation && delete t.navigation, t.scrollbar ? t.scrollbar = { el: ".swiper-scrollbar", ...!0 !== t.scrollbar ? t.scrollbar : {} } : !1 === t.scrollbar && delete t.scrollbar, t.pagination ? t.pagination = { el: ".swiper-pagination", ...!0 !== t.pagination ? t.pagination : {} } : !1 === t.pagination && delete t.pagination, {
            params: t,
            passedParams: s
        }
    }
    ...
    function be(e) {
        ...
        if (a.includes("loop") && t.isElement && (p.loop && !i.loop ? x = !0 : !p.loop && i.loop ? E = !0 : S = !0), d.forEach((e => {
            if (me(p[e]) && me(i[e])) he(p[e], i[e]); else {
                const a = i[e];
                !0 !== a && !1 !== a || "navigation" !== e && "pagination" !== e && "scrollbar" !== e ? p[e] = i[e] : !1 === a && t[s = e] && (t[s].destroy(), "navigation" === s ? (t.isElement && (t[s].prevEl.remove(), t[s].nextEl.remove()), p[s].prevEl = void 0, p[s].nextEl = void 0, t[s].prevEl = void 0, t[s].nextEl = void 0) : (t.isElement && t[s].el.remove(), p[s].el = void 0, t[s].el = void 0))
            }
            var s
        })), d.includes("controller") && !v && t.controller && t.controller.control && p.controller && p.controller.control && (t.controller.control = p.controller.control), a.includes("children") && s && h && p.virtual.enabled && (h.slides = s, h.update(!0)), a.includes("children") && s && p.loop && (S = !0), g) {
            f.init() && f.update(!0)
        }
    ...
    const Se = "undefined" == typeof window || "undefined" == typeof HTMLElement ? class {
    } : HTMLElement;
    ...
    class Ae extends Se {
        ...
        initialize() {
            ...
            this.swiperParams = t, this.passedParams = s, delete this.swiperParams.init, this.render(), this.swiper = new J(this, {
                ...t,
                touchEventsTarget: "container", ...t.virtual ? {} : { observer: !0 },
                onAny: function (s) {
        ...
        connectedCallback() {
            !1 !== this.init && "false" !== this.getAttribute("init") ? this.initialize() : Ee(!0, this)
        }
        ...
        updateSwiperOnPropChange(e) {
            const { params: t, passedParams: s } = we(this);
            this.passedParams = s, this.swiperParams = t, be({
                swiper: this.swiper,
                passedParams: this.passedParams,
                changedParams: [fe(e)], ..."navigation" === e && s[e] ? {
                    prevEl: ".swiper-button-prev",
                    nextEl: ".swiper-button-next"
                } : {}, ..."pagination" === e && s[e] ? { paginationEl: ".swiper-pagination" } : {}, ..."scrollbar" === e && s[e] ? { scrollbarEl: ".swiper-scrollbar" } : {}
            })
        }
    ...
    ue.forEach((e => {
        "init" !== e && (e = e.replace("_", ""), Object.defineProperty(Ae.prototype, e, {
            configurable: !0, get() {
    ...
    "undefined" != typeof window && (window.SwiperElementRegisterParams = e => {
        ue.push(...e)
    }), void 0 === Me && (Me = !0), "undefined" != typeof window && (Me || (xe = !1), xe && Ee(!0), window.customElements.get("swiper-container") || window.customElements.define("swiper-container", Ae), window.customElements.get("swiper-slide") || window.customElements.define("swiper-slide", Te))
}();
